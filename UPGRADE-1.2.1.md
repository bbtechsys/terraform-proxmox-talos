...
What changes when moving from 1.2.0 to 1.2.1 of `bbtechsys/talos/proxmox`.

> Released as 1.2.1. New inputs would normally warrant a minor, but the release went out
> as a patch; the guide is named for the version that shipped.
